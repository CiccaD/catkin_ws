...
(cl:defmethod cl:initialize-instance :after ((m <Led-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Led-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_pkg-srv:<Led-request> is deprecated: use my_pkg-srv:Led-request instead.")))

(cl:ensure-generic-function 'led-val :lambda-list '(m))
(cl:defmethod led-val ((m <Led-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_pkg-srv:led-val is deprecated.  Use my_pkg-srv:led instead.")
  (led m))
...
(cl:defmethod cl:initialize-instance :after ((m <Led-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Led-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_pkg-srv:<Led-response> is deprecated: use my_pkg-srv:Led-response instead.")))

(cl:ensure-generic-function 'res-val :lambda-list '(m))
(cl:defmethod res-val ((m <Led-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_pkg-srv:res-val is deprecated.  Use my_pkg-srv:res instead.")
  (res m))
